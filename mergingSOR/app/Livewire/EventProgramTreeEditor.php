                ...
                'points' => $points->map(function ($point) {
                    $children = $point->children->map(function ($child) {
                        ...
                        return [
                            ...
                            'active' => $props['active'],
                            'show_title_style' => $props['show_title_style'],
    ...
    public function deletePoint($pivotId)
    {
        try {
            ...
            if ($pointPivot) {
                ...
                DB::table('event_template_event_template_program_point')->where('id', $pivotId)->delete();
            ...
            $this->dispatch('notify', ['type' => 'error', 'message' => 'Wystąpił błąd podczas usuwania punktu programu.']);
        }
    }
